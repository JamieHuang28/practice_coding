...
class ConcreteDecoratorB : public Decorator {
 private:
  std::string new_member_;
 public:
  ConcreteDecoratorB(Component* component, const std::string &new_member) : Decorator(component),
    new_member_(new_member){
  }

  std::string Operation() const override {
    return "ConcreteDecoratorB(" + Decorator::Operation() + new_member_ + ")";
  }
};
...
int main() {
  ...
  Component* decorator2 = new ConcreteDecoratorB(decorator1, " with new_member");
